        ...
        <div class="detail-top">
          ...
          <div class="detail-head">
            ...
            <div class="detail-btns">
              ...
              <button class="dbtn-icon${wl ? ' active' : ''}" data-lc="${type}|${id}" data-action="open-list-picker" data-item="${wlPayload}" aria-label="Add to lists" data-tip="Add to lists…"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h11M4 12h11M4 18h7M17 15l3 3-3 3M20 18h-9"/></svg></button>
